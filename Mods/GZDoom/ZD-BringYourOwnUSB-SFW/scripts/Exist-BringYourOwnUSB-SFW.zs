...
// Existence for BringYourOwnUSB SFW
/*
...
class LMBH_BYOU_Existence_SFW : LMBH_ExistenceVerifier
{
    Default
	{
		LMBH_ExistenceVerifier.name "LMBH_BringYourOwnUSB-SFW"; // name to whatever you want. This would be the ID of it, for other format reasons
